import { JsonRpcTransportFactory } from '../chunk-GCMAJIJB.js';
export { A2AClient, HiveA2AClient, JsonRpcTransport, JsonRpcTransportFactory } from '../chunk-GCMAJIJB.js';
import '../chunk-6CT5KQ5Q.js';
import { AgentCard, FromProto, ToProto, SendMessageRequest, SendMessageResponse, TaskPushNotificationConfig, ListTaskPushNotificationConfigResponse, Task, StreamResponse } from '../chunk-UJAJBRMB.js';
import { parseSseStream, A2A_ERROR_CODE, AuthenticatedExtendedCardNotConfiguredError, InvalidAgentResponseError, ContentTypeNotSupportedError, UnsupportedOperationError, PushNotificationNotSupportedError, TaskNotCancelableError, TaskNotFoundError, AGENT_CARD_PATH, HTTP_EXTENSION_HEADER } from '../chunk-JKJJLJQL.js';
export { AuthenticatedExtendedCardNotConfiguredError, ContentTypeNotSupportedError, InvalidAgentResponseError, PushNotificationNotSupportedError, TaskNotCancelableError, TaskNotFoundError, UnsupportedOperationError } from '../chunk-JKJJLJQL.js';
...
var ClientFactory = class {
  ...
  async createFromAgentCard(agentCard) {
    const agentCardPreferred = agentCard.preferredTransport ?? JsonRpcTransportFactory.protocolKey;
...
export { AgentCardResolver, Client, ClientCallContext, ClientCallContextKey, ClientFactory, ClientFactoryOptions, DefaultAgentCardResolver, RestTransport, RestTransportFactory, ServiceParameters, createAuthenticatingFetchWithRetry, withA2AExtensions };
