...
// src/core/types/pb/a2a_types.ts
...
// src/core/types/converters/id_decoding.ts
...
var extractTaskId = (name) => {
  ...
  if (!match) {
    throw chunk6NYM5ZKZ_cjs.A2AError.invalidParams(`Invalid or missing task ID in: "${name}"`);
  }
  return match[1];
};
...
var extractTaskAndPushNotificationConfigId = (name) => {
  ...
  if (!match) {
    throw chunk6NYM5ZKZ_cjs.A2AError.invalidParams(`Invalid or missing config ID in: "${name}"`);
  }
...
// src/core/types/converters/from_proto.ts
var FromProto = class _FromProto {
  ...
  static createTaskPushNotificationConfig(request) {
    if (!request.config?.pushNotificationConfig) {
      throw chunk6NYM5ZKZ_cjs.A2AError.invalidParams(
  ...
  static role(role) {
    switch (role) {
      ...
      case 1 /* ROLE_USER */:
        return "user";
      default:
        throw chunk6NYM5ZKZ_cjs.A2AError.invalidParams(`Invalid role: ${role}`);
    }
  }
  ...
  static part(part) {
    ...
    if (part.part?.$case === "file") {
      ...
      throw chunk6NYM5ZKZ_cjs.A2AError.invalidParams("Invalid file part type");
    }
    ...
    throw chunk6NYM5ZKZ_cjs.A2AError.invalidParams("Invalid part type");
  }
  ...
  static sendMessageResult(response) {
    ...
    throw chunk6NYM5ZKZ_cjs.A2AError.invalidParams("Invalid SendMessageResponse: missing result");
  }
  static task(task) {
    return {
      kind: "task",
  ...
  static taskState(state) {
    switch (state) {
      ...
      case 0 /* TASK_STATE_UNSPECIFIED */:
        return "unknown";
      default:
        throw chunk6NYM5ZKZ_cjs.A2AError.invalidParams(`Invalid task state: ${state}`);
    }
  }
  ...
  static securityScheme(securitySchemes) {
    switch (securitySchemes.scheme?.$case) {
      ...
      default:
        throw chunk6NYM5ZKZ_cjs.A2AError.internalError(`Unsupported security scheme type`);
    }
  }
  static oauthFlows(flows) {
    switch (flows.flow?.$case) {
      ...
      default:
        throw chunk6NYM5ZKZ_cjs.A2AError.internalError(`Unsupported OAuth flows`);
    }
  }
  static skills(skill) {
    return {
  ...
  static messageStreamResult(event) {
    switch (event.payload?.$case) {
      ...
      default:
        throw chunk6NYM5ZKZ_cjs.A2AError.internalError("Invalid event type in StreamResponse");
    }
  }
};

// src/core/types/converters/to_proto.ts
var ToProto = class _ToProto {
  ...
  static messageStreamResult(event) {
    if (event.kind === "message") {
      ...
      throw chunk6NYM5ZKZ_cjs.A2AError.internalError("Invalid event type");
    }
  }
  static taskStatusUpdateEvent(event) {
    return {
  ...
  static role(role) {
    switch (role) {
      ...
      case "user":
        return 1 /* ROLE_USER */;
      default:
        throw chunk6NYM5ZKZ_cjs.A2AError.internalError(`Invalid role`);
    }
  }
  static task(task) {
    return {
  ...
  static part(part) {
    ...
    if (part.kind === "file") {
      ...
      if ("uri" in part.file) {
        ...
        throw chunk6NYM5ZKZ_cjs.A2AError.internalError("Invalid file part");
      }
      return {
    ...
    throw chunk6NYM5ZKZ_cjs.A2AError.internalError("Invalid part type");
  }
...
exports.CreateTaskPushNotificationConfigRequest = CreateTaskPushNotificationConfigRequest;
exports.FromProto = FromProto;
exports.ListTaskPushNotificationConfigResponse = ListTaskPushNotificationConfigResponse;
exports.SendMessageRequest = SendMessageRequest;
exports.SendMessageResponse = SendMessageResponse;
exports.StreamResponse = StreamResponse;
exports.Task = Task;
exports.TaskPushNotificationConfig = TaskPushNotificationConfig;
