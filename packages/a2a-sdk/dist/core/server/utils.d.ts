 ...
 */
export declare function isTaskStatusUpdate(update: unknown): update is Omit<TaskStatus, 'timestamp'>;
/**
 * Type guard to check if an object is an Artifact update (has 'parts').
 * Used to differentiate yielded updates from the handler.
 */
export declare function isArtifactUpdate(update: unknown): update is Artifact;
