...
var TaskNotFoundJSONRPCError = class extends chunk22BKFC5W_cjs.TaskNotFoundError {
  constructor(errorResponse) {
    super();
    this.errorResponse = errorResponse;
  }
};
var TaskNotCancelableJSONRPCError = class extends chunk22BKFC5W_cjs.TaskNotCancelableError {
  constructor(errorResponse) {
    super();
    this.errorResponse = errorResponse;
  }
};
var PushNotificationNotSupportedJSONRPCError = class extends chunk22BKFC5W_cjs.PushNotificationNotSupportedError {
  constructor(errorResponse) {
    super();
    this.errorResponse = errorResponse;
  }
};
var UnsupportedOperationJSONRPCError = class extends chunk22BKFC5W_cjs.UnsupportedOperationError {
  constructor(errorResponse) {
    super();
    this.errorResponse = errorResponse;
  }
};
var ContentTypeNotSupportedJSONRPCError = class extends chunk22BKFC5W_cjs.ContentTypeNotSupportedError {
  constructor(errorResponse) {
    super();
    this.errorResponse = errorResponse;
  }
};
var InvalidAgentResponseJSONRPCError = class extends chunk22BKFC5W_cjs.InvalidAgentResponseError {
  constructor(errorResponse) {
    super();
    this.errorResponse = errorResponse;
  }
};
var AuthenticatedExtendedCardNotConfiguredJSONRPCError = class extends chunk22BKFC5W_cjs.AuthenticatedExtendedCardNotConfiguredError {
  constructor(errorResponse) {
    super();
    this.errorResponse = errorResponse;
  }
...
var A2AClient = class _A2AClient {
   ...
   */
  resolveAgentCardUrl(agentBaseUrl, agentCardPath = chunk22BKFC5W_cjs.AGENT_CARD_PATH) {
...
var HiveA2AClient = class _HiveA2AClient {
  ...
  async getAgentCard() {
    ...
    this.peerIsHive = chunkFEJHDJOG_cjs.supportsNoise(card);
    return card;
  }
...
exports.HiveA2AClient = HiveA2AClient;
exports.JsonRpcTransport = JsonRpcTransport;
exports.JsonRpcTransportFactory = JsonRpcTransportFactory;
